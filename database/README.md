...
13-reset-ai-automation.sql is a reset utility script to wipe all contents and configure the active business as 'AI Automation' (Digital Service) and product as 'Personal Branding'.
